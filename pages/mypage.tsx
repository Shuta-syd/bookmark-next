    ...
    <>
      <div className="container mx-auto px-6 py-16">
        {props.articles.length > 0 ? (
                        ...
                        <td className="py-4 pl-10">
                          <div>
                            ...
                            <div className="font-medium text-gray-400">
                              {article.users.length > 1 ? `${article.users.length} users` : `${article.users.length} user`} {' '}
          ...
          // ブックマークしている記事が存在しない場合、記事の一覧ページへのリンクを表示
          <div className="text-center">
            ...
            <Link
              href={'/articles'}
              className='group mt-5 inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 p-0.5 font-medium text-gray-900 hover:text-white focus:ring-4 focus:ring-blue-300 group-hover:from-purple-600 gruop-hover:to-blue-500'
            >
